...
class Player(Agent):
	...
	def update(self,player, range):
		...
		if pressed[pygame.K_w] or pressed[pygame.K_UP]: self.vel.VecY -= 1
		if pressed[pygame.K_s] or pressed[pygame.K_DOWN]: self.vel.VecY += 1
		if pressed[pygame.K_a] or pressed[pygame.K_LEFT]: self.vel.VecX -= 1
		if pressed[pygame.K_d] or pressed[pygame.K_RIGHT]: self.vel.VecX += 1
